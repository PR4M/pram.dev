<section class="relative bg-white">
    <div class="text-xs text-gray-400 space-y-4 relative">
        <div class="max-w-6xl py-6 relative h-full mx-auto flex flex-col sm:items-center sm:justify-between md:flex-row md:space-y-0">
    ...
    <div class="flex md:flex-row flex-col-reverse items-stretch border-gray-200 justify-center h-full mx-auto max-w-6xl md:space-x-10">
        <div
    ...
    <div class="text-xs text-gray-500 space-y-4 ">
        <div
            class="max-w-6xl border-gray-200 py-6 h-full mx-auto flex flex-col sm:items-center sm:justify-between md:flex-row md:space-y-0">
