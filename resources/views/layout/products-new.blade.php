...
<body class="bg-gray-50">
    ...
    <!-- credibility -->
    @include('components.credibility', ['tagline' => 'These products brought to you by the maker of'])
                ...
                <section aria-labelledby="products-heading" class="pt-6 pb-24">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
                        ...
                        <div class="lg:col-span-3">
                            ...
                            <div class="grid grid-cols-1 gap-x-8 gap-y-8 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-2">
