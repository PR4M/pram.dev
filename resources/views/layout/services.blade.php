        ...
        <main>
            ...
            <div class="bg-white pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
                <div class="relative max-w-lg mx-auto  lg:max-w-7xl">
                    ...
                    <div class="text-center py-2 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="max-w-2xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:max-w-7xl lg:px-8">
                        ...
                        <div class="p-6 bg-white sm:p-8 rounded-xl ring ring-indigo-50">
                            ...
                            <div class="sm:ml-8">
                                ...
                                <h2 class="mt-4 text-lg font-medium sm:text-xl">
                                <a href="" class="hover:underline"> Mobile Apps Development </a>
                                </h2>
                        ...
                        <div class="p-6 bg-white sm:p-8 rounded-xl ring ring-indigo-50">
                            ...
                            <div class="sm:ml-8">
                                ...
                                <h2 class="mt-4 text-lg font-medium sm:text-xl">
                                <a href="" class="hover:underline"> Server Setup & Apps Deployment </a>
                                </h2>
                        ...
                        <div class="p-6 bg-white sm:p-8 rounded-xl ring ring-indigo-50">
                            ...
                            <div class="sm:ml-8">
                                ...
                                <h2 class="mt-4 text-lg font-medium sm:text-xl">
                                <a href="" class="hover:underline"> WordPress Websites Development </a>
                                </h2>
            ...
            <!-- Recent Works -->
            <div class="bg-slate-100 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
                <div class="relative max-w-lg mx-auto  lg:max-w-7xl">

                    <div class="text-center py-2 px-4 sm:px-6 lg:px-8">
                        <h1 class="text-4xl font-extrabold tracking-tight text-gray-900">Recent Works</h1>
                        <p class="mt-4 max-w-xl mx-auto text-base text-gray-500">The secret to a tidy desk? Don't get rid of anything, just put it in really really nice looking containers.</p>
                    </div>
