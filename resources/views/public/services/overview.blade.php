...
<html lang="en">
    ...
    <body>
                      ...
                      <div class="flex-1 min-w-0">
                        ...
                        <div class="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-8">
                          ...
                          <div class="mt-2 flex items-center text-sm text-gray-500">
                            ...
                            ${{ $service->price }} ({{ $service->local_price }})
                          </div>
                        </div>
                      </div>
                ...
                <div class="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl py-8 lg:grid lg:grid-cols-12 lg:gap-8">
                    <main class="pr-6 lg:col-span-7 xl:col-span-7">
                        ...
                        <div class="w-full max-w-2xl mx-auto mt-16 lg:max-w-none lg:mt-0 lg:col-span-4">
                            <div class="px-3">
                                <h2 class="text-xl my-6 font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate mb-4">{{ __('label.service_description') }}</h2>
                    ...
                    <aside class="xl:block xl:col-span-5">
                        <div class="sticky space-y-4 top-4">
                            ...
                            <div class="max-w-2xl mx-auto mt-14 sm:mt-16 lg:max-w-none lg:mt-0 lg:row-end-2 lg:row-span-2 lg:col-span-3">
                                ...
                                <div class="mt-4">
                                    <h2 class="text-xl font-bold leading-7 text-gray-900 sm:text-2xl sm:truncate">{{ __('label.service_summary') }}</h2>

                                    <p class="text-sm text-gray-500 mt-2">
                                        {{ __('hint.hired_times', ['count' => $service->total_orders]) }}
                                    </p>
                                </div>
                                                    ...
                                                    <li class="text-gray-900 cursor-default select-none relative px-4 text-sm" id="listbox-option-0" role="option">
                                                        <div class="flex flex-col">
                                                          ...
                                                          <p class="pb-4 text-gray-500">
                                                            ...
                                                            @if ($channel['url'] == 'upwork')
                                                            {{ __('hint.channel_upwork') }}
                                                            @else
                                                            {{ __('hint.channel_fiverr') }}
                                                            @endif
                                ...
                                <h3 class="text-sm font-medium text-gray-900">{{ __('label.confidentiality') }}</h3>

                                <p class="mt-4 text-sm text-gray-500">
                                    {{ __('hint.confidentiality') }}
                                </div>

                                <!-- Share -->
                                <div class="border-t border-gray-200 mt-4 pt-4">
                                <h3 class="text-sm font-medium text-gray-900">{{ __('label.share') }}</h3>
                                ...
                                <!-- Reviews -->
                                <div class="border-t border-gray-200 mt-4 pt-4">
                                <h3 class="text-sm font-medium text-gray-900">{{ __('label.client_reviews') }}</h3>
        ...
        @include('components.credibility', ['tagline' => __('label.credibility_for_service') ])
